...
const QuickActionBtn: React.FC<{ icon: string, label: string, onClick: () => void, colorClass: string }> = ({ icon, label, onClick, colorClass }) => (
    <button
        onClick={onClick}
...
const StatCard: React.FC<{ title: string, value: string | number, subValue: string, icon: string, colorGradient: string }> = ({ title, value, subValue, icon, colorGradient }) => (
...
const ActivityItem: React.FC<{ item: ActivityLog, isLast: boolean }> = ({ item, isLast }) => (
